...
public class Result implements ITestListener{
	...
	public static void generateResult(int pass, int fail) {
		try {
			...
			FileOutputStream fos = new FileOutputStream("C:\\Users\\ssamr\\git\\Automation\\result\\summary.xlsx");
			wb.write(fos);
		}
		catch(Exception e) {
			e.printStackTrace();
	...
	public void onFinish(ITestContext context) {
		...
		generateResult(passCount, passCount);
